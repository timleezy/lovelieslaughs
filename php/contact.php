...
$title = 'LLL Contact Page';
$to = 'lovelieslaughsinfo@gmail.com';
$subject = 'LLL Contact Page';
$headers = 'From: (LLL Contact Page)' . "\r\n" . 'Content-type: text/html; charset=utf-8';
													...
													<td width="200" valign="top" align="center">
														<div class="contentEditableContainer contentImageEditable">
						                					<div class="contentEditable" align="center" style="max-width: 7.2em; max-height: 7.2em; width: 7.2em; height: 7.2em; padding: 9px; text-align: center; display: table-cell; vertical-align: middle;">
						                  						<img src=https://template.brainwave.scientecraft.com/build/img/content/logo_2.png width="107" height="102"  alt="Logo"/>
						                					</div>
						              					</div>
													</td>
													<td width="200" valign="top">&nbsp;</td>
