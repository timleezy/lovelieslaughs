...
if($_POST)
{
    $to_Email       = "lovelieslaughsinfo@gmail.com"; // Replace with recipient email address
	$subject        = 'Contact Page Message: '.$_SERVER['SERVER_NAME']; //Subject line for emails
    
    $host           = "smtp.mail.gmail.com"; // Your SMTP server. For example, smtp.mail.yahoo.com
    $username       = "lovelieslaughsinfo@gmail.com"; //For example, your.email@yahoo.com
    $password       = "Mm061677"; // Your password
